...
function Card({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      data-slot="card"
      className={cn(
        'bg-card text-card-foreground flex flex-col gap-6 rounded-2xl border border-border/50 shadow-sm transition-all duration-300 hover:shadow-md dark:hover:border-border/80',
        className,
      )}
      {...props}
    />
...
function CardTitle({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn('leading-tight font-bold text-xl tracking-tight', className)}
      {...props}
    />
  )
}
